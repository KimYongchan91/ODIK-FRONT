...
const String keyTokenOdik = "token_odik";
...
const String keyApple = "apple";

const String keyMale = "male";
const String keyMale2 = "m";
const String keyFemale = "female";
const String keyFemale2 = "f";
...
const String keyUserIdx = 'user_idx';
...
const String keyLocationLng = "location_lng";

const String keyCart = "cart";
const String keyPublic = "public";
const String keyDelete = "delete";

const String keyOk = 'OK';
const String keySend = 'SEND';
const String keyAlreadyExist = 'ALREADY_EXIST';
const String keyWrongCode = 'WRONG_CODE';
